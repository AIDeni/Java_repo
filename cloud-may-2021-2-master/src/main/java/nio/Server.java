    ...
    private void handleRead(SelectionKey key) {
        ...
        try {
            ...
            if (message.equals("ls")) {
                String files = Files.list(Paths.get(dir)).map(p -> p.getFileName().toString()).collect(Collectors.joining("\n")) + "\n\r";
                ...
                String folderName = message.replaceAll("mkdir ", "");
                Path path = Paths.get(dir + folderName);
                try {
                ...
                String fileName = message.replaceAll("mkdir ", "");
